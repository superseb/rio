...
1. Portability.  Each Rio cluster should have the same functionality available to it.  The differences between clusters
...
1. Solutions Oriented. Rio is not about giving flexible primitives, but instead using the primitives to enable end user solutions.
...
Standalone requires Linux 4.x+ that support overlay and containers in general.  This will be most current distributions.
